...
SENSITIVE_PATHS: Mapping[str, tuple[str, ...]] = {
    ...
    "spatial": (
        ...
        "backend/app/services/spatial_projection.py",
        "backend/app/services/spatial_service.py",
        "frontend/src/lib/spatialEditor.ts",
        "frontend/src/lib/spatialGeometry.ts",
        "frontend/src/lib/spatialMeshes.ts",
    ),
    "home_design": (
        "backend/app/api/routes/home_delivery_snapshot.py",
        "backend/app/api/routes/home_design.py",
        "backend/app/api/routes/home_design_agent.py",
        "backend/app/api/routes/home_design_delivery.py",
        "backend/app/api/routes/products.py",
        "backend/app/schemas/home_delivery_snapshot.py",
        "backend/app/schemas/home_design.py",
        "backend/app/schemas/home_design_agent.py",
        "backend/app/schemas/home_design_asset.py",
        "backend/app/schemas/home_design_impact.py",
        "backend/app/schemas/home_quote.py",
        "backend/app/services/home_delivery_snapshot_service.py",
        "backend/app/services/home_design_agent_service.py",
        "backend/app/services/home_design_asset_service.py",
        "backend/app/services/home_design_delivery.py",
        "backend/app/services/home_design_impact_service.py",
        "backend/app/services/home_design_service.py",
        "backend/app/services/home_design_validation.py",
        "backend/app/services/home_installation_validation.py",
        "backend/app/services/home_quote_service.py",
        "frontend/src/lib/homeDesignEditor.ts",
        "frontend/src/lib/homeQuote.ts",
        "frontend/src/lib/homeSurfacePricing.ts",
        "frontend/src/types/homeDesign.ts",
    ),
    "release": (
