    ...
    *,
    ...
    try:
        for sku, spec in specs.items():
            ...
            product.region_codes = []
            product.stock_quantity = None
            product.lead_time_days_min = None
            product.lead_time_days_max = None
            product.price_valid_from = None
            product.price_valid_to = None
            product.verified_at = None
            product.verified_by = None
            product.data_version = "merchant-draft-2026-08-30"
