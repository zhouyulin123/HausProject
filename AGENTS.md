...
- 当前最终回归基线为后端 1617 项通过、8 项跳过，前端 93 个测试文件共 484 项通过，TypeScript 与生产构建通过；精确命令、浏览器旅程和边界见 V2 路线书 2026-09-20 记录。
...
- 本机开发数据库和 Alembic 代码均处于唯一 head `f6a7b8c9d0e1`。最新验证数量、浏览器证据、真实模型报告和未完成门禁见 [V2 开发路线书](./V2开发路线书.md)。本批按用户要求尚未提交 Git。
...
- 旧状态文档中未提交的两项 2026-09-14 工作台记录已原样迁入 V1 指南；此前已跟踪的历史计划与记录可从 Git 历史追溯。本轮没有提交或推送 Git。
