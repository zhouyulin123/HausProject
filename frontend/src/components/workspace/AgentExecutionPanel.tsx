...
const EXIT_LABELS: Partial<Record<AgentExitReason, string>> = {
  ...
  approval_recorded: "审批已记录，请重新执行校验",
  quote_revision_required: "报价依据需要补充",
  quality_revision_required: "方案约束需要修改",
  safety_user_revision_required: "高风险请求需要修改",
  timeout: "执行已超时",
